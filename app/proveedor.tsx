...
export default function ProveedorScreen() {
  ...
  const handleCharge = async () => {
    if (!session || !canCharge) {
      setError("Escanea un QR de cliente válido y completa establecimiento y monto.");
      return;
    }
            ...
            {paymentMethod === "nip" ? (
              <View style={styles.field}>
                ...
                <TextInput
                  ...
                  value={nip}
                />
                <Text style={styles.hintText}>Debe tener exactamente 4 dígitos.</Text>
              </View>
            ) : null}
        ...
        {/*   <View style={styles.panel}>
             <View style={styles.consumosHeader}>
              <View>
                ...
                <Text style={styles.hintText}>Solo operaciones del día actual.</Text>
              </View>
